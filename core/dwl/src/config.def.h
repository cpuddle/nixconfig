...
/* 1 means idle inhibitors will disable idle tracking even if it's
          surface isn't visible  */
static const int smartgaps = 0;
/* 1 means no outer gap when there is only one window */
static int gaps = 1;
/* 1 means gaps between windows are added */
...
static const Key keys[] = {
    ...
    {MODKEY | WLR_MODIFIER_SHIFT,       XKB_KEY_R,             spawn,          {.v = waybarreload}},
