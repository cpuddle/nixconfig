...
ENCRYPTION_PIPE = ['gpg', '--encrypt', '--recipient', 'collin@collinfranklin.com']
...
registrations = {
    ...
    'microsoft': {
        'authorize_endpoint': 'https://login.microsoftonline.com/30a228e0-6189-4641-8a5c-294972f34c0b/oauth2/v2.0/authorize',
        'devicecode_endpoint': 'https://login.microsoftonline.com/30a228e0-6189-4641-8a5c-294972f34c0b/oauth2/v2.0/devicecode',
        'token_endpoint': 'https://login.microsoftonline.com/30a228e0-6189-4641-8a5c-294972f34c0b/oauth2/v2.0/token',
        'redirect_uri': 'http://localhost/',
        'tenant': '30a228e0-6189-4641-8a5c-294972f34c0b',
